...
public sealed class FileReader : IDisposable
{
    ...
    /// <summary>
    /// Reads a <see cref="string"/> value from the stream at a given position using <see cref="Encoding.UTF8"/> as encoding.
    /// Trailing null-bytes are removed.
    /// </summary>
    /// <param name="position">The absolute position in the stream to start reading from.</param>
    /// <param name="length">The number of bytes to read.</param>
    ...
    /// <summary>
    /// Reads a null-terminated <see cref="string"/> value from the stream at a given position using <see cref="Encoding.UTF8"/> as encoding.
    /// Trailing null-bytes are removed.
    /// </summary>
    /// <param name="position">The absolute position in the stream to start reading from.</param>
    /// <param name="maxLength">The maximum number of bytes to read.</param>
