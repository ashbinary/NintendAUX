...
public class SarcFileParser : SarcUtils.IFileParser<SarcFile>, SarcUtils.IAlignedArchiveParser
{
    ...
    public static List<SarcUtils.AlignmentInfo> CheckAlignmentStatic(Stream fileStream, SarcUtils.AlignmentTable table)
    {
        ...
        for (var i = 0; i < infos.Count; ++i)
        {
            ...
            info.ExpectedDataStart = currentDataOffset += Utilities.GetOffset(currentDataOffset, alignment);
    ...
    /// <exception cref="ArgumentNullException"></exception>
    /// <exception cref="InvalidDataException"></exception>
    public List<SarcUtils.AlignmentInfo> CheckAlignment(Stream fileStream, SarcUtils.AlignmentTable table) => CheckAlignmentStatic(fileStream, table);
    #endregion
