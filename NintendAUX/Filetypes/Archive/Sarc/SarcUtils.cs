...
public class SarcUtils
{
    ...
    public class AlignmentTable : IEnumerable<KeyValuePair<string, int>>
    {
        ...
        public bool Add(string extension, int alignment)
        {
            ...
            return _alignment.TryAdd(extension.StartsWith('.') ? extension : '.' + extension,
        ...
        {
            return _alignment.ContainsKey(extension);
        }
        ...
        /// <returns>
        ///     <see langword="true" /> if the alignment was found and removed successfully; otherwise
        ///     <see langword="false" />.
        /// </returns>
        public bool Remove(string extension)
        {
            return _alignment.Remove(extension.StartsWith('.') ? extension : '.' + extension);
        }
        ...
        public int Get(string extension)
        {
            return _alignment.GetValueOrDefault(extension, Default);
        }
        ...
        {
            return _alignment.TryGetValue(extension, out alignment);
        }
        ...
        public int GetFromName(string fileName)
        {
            ...
            {
                if (fileName[index] == '.' && _alignment.TryGetValue(fileName[index..], out var value)) return value;
        ...
        {
            return _alignment.GetEnumerator();
        }
