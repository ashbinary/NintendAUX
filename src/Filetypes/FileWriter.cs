...
public sealed class FileWriter : IDisposable
{
    ...
    /// <summary>
    ///     Whether the base stream will be expanded (padded with null-bytes) if accessing a position beyond the current
    ///     length.
    /// </summary>
    ...
    {
        var offset = BinaryUtilities.GetOffset(Position, alignment);
    ...
    /// <summary>
    ///     Writes a given <see cref="string" /> value to the stream at a given position using <see cref="Encoding.UTF8" /> as
    ///     encoding.
    /// </summary>
    /// <param name="position">The absolute position in the stream to start writing at.</param>
    /// <param name="value">The value to write.</param>
    ...
    /// </summary>
    /// <param name="value">The value to write.</param>
    public void WriteTerminated(string value)
    {
        Write(value + "\0", Encoding.UTF8);
    }
    ...
    /// <param name="value">The value to write.</param>
    /// <param name="encoding">The encoding to use.</param>
    public void WriteTerminated(string value, Encoding encoding)
    {
        Write(value + "\0", encoding);
    }
